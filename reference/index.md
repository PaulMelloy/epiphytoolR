...
- [`Audpc()`](https://paulmelloy.com.au/epiphytoolR/reference/Audpc.md)
  : Calculate area under the disease progress curve (AUPDC)
- [`DIV()`](https://paulmelloy.com.au/epiphytoolR/reference/DIV.md) :
  Daily Infection Values
- [`DIV_Tm_index()`](https://paulmelloy.com.au/epiphytoolR/reference/DIV_Tm_index.md)
...
- [`calc_fpea_emergence()`](https://paulmelloy.com.au/epiphytoolR/reference/calc_fpea_emergence.md)
...
- [`calc_vpd()`](https://paulmelloy.com.au/epiphytoolR/reference/calc_vpd.md)
  : Calculate Vapour-pressure deficit from relative humidity and
  temperature
- [`circular_influence()`](https://paulmelloy.com.au/epiphytoolR/reference/circular_influence.md)
  : Calculate the influence of 2 dimensional vectors
- [`create_inf_xyz()`](https://paulmelloy.com.au/epiphytoolR/reference/create_inf_xyz.md)
  : Create xyz data.frame with z plots
- [`disease_aug_soil()`](https://paulmelloy.com.au/epiphytoolR/reference/disease_aug_soil.md)
  : DiseaseAUGSoil - number of girdled internodes
- [`est_primary_inoculum()`](https://paulmelloy.com.au/epiphytoolR/reference/est_primary_inoculum.md)
  : Estimate blackspot primary inoculum
- [`exp_dk()`](https://paulmelloy.com.au/epiphytoolR/reference/exp_dk.md)
...
- [`get_bom_observations()`](https://paulmelloy.com.au/epiphytoolR/reference/get_bom_observations.md)
...
- [`merge_weather()`](https://paulmelloy.com.au/epiphytoolR/reference/merge_weather.md)
  : Merge 'latest' BOM weather data
- [`multi_var_binom()`](https://paulmelloy.com.au/epiphytoolR/reference/multi_var_binom.md)
  : Splash dispersal multi-binomial in a pixel
- [`power_dk()`](https://paulmelloy.com.au/epiphytoolR/reference/power_dk.md)
  : Power law dispersal kernal
- [`weather`](https://paulmelloy.com.au/epiphytoolR/reference/weather.md)
  : Simulated weather data
- [`wind_angle()`](https://paulmelloy.com.au/epiphytoolR/reference/wind_angle.md)
  : Estimates Bearing Conidia Dispersed by Wind Driven Rain
- [`wind_distance()`](https://paulmelloy.com.au/epiphytoolR/reference/wind_distance.md)
