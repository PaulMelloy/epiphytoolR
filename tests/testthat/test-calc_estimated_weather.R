...
test_that("calc_estimated_weather example works", {
   ...
   expect_equal(dim(out1),c((24*334)+1,22))
...
test_that("calc_estimated_weather example works", {
   ...
   expect_equal(nrow(out2[station == "w_STATION10"]),c((24*334)+1))
   expect_equal(dim(out2),c((24*334*4)+4,22))
...
test_that("format_weather can format it",{
   ...
   format_weather(w = out1,time_zone = "UTC")
})
